...
#include "../HADB_GUI/show_database.h"
...
const QMetaObject Show_Database::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Show_Database.data,
      qt_meta_data_Show_Database,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Show_Database::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Show_Database.stringdata0))
        return static_cast<void*>(const_cast< Show_Database*>(this));
